...
| 2   | **En tant que qu'** utilisateur **je souhaite** créer des User Story (descrition, type, id généré automatiquement, état = "ouvert" par défaut) **afin de** pouvoir les organiser et réaliser leur suivie.                                                                                      | 1          |            |        |
...
| 22  | **En tant qu'** Chef de projet **je souhaite** pouvoir modifié la difficulté d'une User Story à l'aide d'une liste déroulante FACILE, MOYENNE, DUR **afin de** pouvoir généré la difficulté de chaque issue                                                                                    | 2          |            |        |
| 26  | **En tant que** PO **je souhaite** pouvoir modifié l'importance d'une User Story à l'aide d'une liste déroulante HAUTE, MOYENNE, FAIBLE **afin de** pouvoir générer l'importance de chaque issue                                                                                               | 2          |            |        |
| 8   | **En tant qu’** Chef de projet **je souhaite** pouvoir généré automatiquement un Pert pour le projet global et un pour chaque sprint **afin de** pourvoir organiser le développement                                                                                                           | 5          |            |        |
...
| 11  | **En tant qu'** Developpeur, **je souhaite** pouvoir uploader pour chaque test une vidéo de son exécution **afin de** permettre aux autres membres de voir en un coup d'oeil ce qui est testé                                                                                                  | 2          |            |        |
| 12  | **En tant qu'** utilisateur, **je souhaite** pouvoir créer une page release qui contiendrait le nom*, la version*, lien vers le fichier*, la vidéo de démo des fonctionnalités, les instructions d'installation / documentation, la liste des User Story présentes dans la release, la date **afin de** pouvoir les integrer                       | 2          |            |        |
...
| 16  | **En tant qu'** Develloppeur **je souhaite** pouvoir ajouter un test (nom, tâches associées) dans mon projet via un bouton **afin de** pouvoir définir si les tâches associées sont terminées ou non                                                                                           | 1          |            |        |
| 17  | **En tant qu'** Devellopeur **je souhaite** définir si un test du projet est : "Pas encore exécuté", "Réussi" ou "Échoué" **afin de** savoir l'avancement de nos tests                                                                                                                         | 1          |            |        |
| 18  | **En tant qu'** Devellopeur **je souhaite** lier mon test à un fichier de test sur github **afin de** récupérer son scénario et sa description pour l'ajouter à notre test                                                                                                                     | 3          |            |        |
| 19  | **En tant qu'** Devellopeur **je souhaite** ajouter à mon test, via un bouton ou une zone de drag and drop, une vidéo de son exécution **afin de** pouvoir revoir rapidement le test sans le relancer, ou voir le test d'une ancienne version                                                  | 1          |            |        |
