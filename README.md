...
| 3 | **En tant qu'** Chef de projet, **je souhaite** pouvoir modifier l'état d'une user story à l 'aide d'une liste d'état (OUVERT, EN COURS, TESTABLE, TESTEE, CLOTUREE), ou modifié les différents autre champs d'un US à l'aide d'un formulaire classique **afin de** rectifier certaine informations. | 1 | 1 | 1|
