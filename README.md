...
| 26  | **En tant que** PO **je souhaite** pouvoir drag & drop une issues dans des colonnes d'importance HAUTE, MOYENNE, FAIBLE **afin de** pouvoir généré l'importance de chaque issue                                                                                                   | 2          |            |        |
...
| 16  | **En tant qu'** utilisateur **je souhaite** ajouter un test (nom, tâches associées) dans mon projet via un bouton **afin de** pouvoir définir si les tâches associées sont terminées ou non                                                                                                                                                                                                       | 1          |            |        |
