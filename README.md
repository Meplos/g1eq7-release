...
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ---------- | ------ |
| 1   | **En tant qu'** utilisateur **je souhaite** pouvoir créer un projet. Un projet comporte un nom, une date de début, une date de fin estimée (possiblement null? ), un depot git, une description, un état **afin de** pouvoir saisir et plannifier mes User Story, tasks, tests et release | 1          |            |        |
...
| 6   | **En tant qu'** utilisateur, **je souhaite** pouvoir créer différents sprints (date de début, date de fin, id générér automatiquement ) afin de pouvoir plus tard plannifier mes différentes User Story.                                                                                  | 1          |            |        |
| 7   | **En tant qu’** utilisateur, **je souhaite** pouvoir ajouter une issue dans un sprint à l'aide d'un drag & drop ou à l'aide d'une liste **afin de** plannifier mes User Story.                                                                                                            | 1          |            |        |
| 22  | **En tant qu'** utilisateur **je souhaite** pouvoir drag & drop une User Story dans des colonnes FACILE, MOYENNE, DUR **afin de** pouvoir généré la difficulté de chaque issue                                                                                                            | 2          |            |        |
...
| 12  | **En tant qu'** utilisateur, **je souhaite** pouvoir créer une page release qui contiendrait le nom, la version, lien vers le fichier, la vidéo, la page d'installation, la liste des User Story présentes dans la release,la date **afin de** pouvoir les integrer                       | 2          |            |        |
...
| 23  | **En tant qu'** utilsateur **je souhaite** visualiser sur la page d'acceuil du projet son avancement (tâches à effectuer cette semaine, % de complétion du sprint, des tâches, des User Story, des tests) **afin d'** avoir une vision globale de l'avancement du projet                  | 1          |            |        |
